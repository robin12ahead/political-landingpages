...
if ($optionsAddons["medienberichte_status"] == true) {

    
// Add Custom Post Type
function create_post_type_medienbericht() {
    ...
    $labels = array(
        'name' => _x('Medienberichte', 'plural'),
        'singular_name' => _x('Medienbericht', 'singular'),
        'menu_name' => _x('Medienberichte', 'admin menu'),
        'name_admin_bar' => _x('Medienberichte', 'admin bar'),
        'add_new' => _x('Neuer Medienbericht', 'add new'),
        'add_new_item' => __('Neuer Medienbericht'),
        'new_item' => __('Neuer Medienbericht'),
        'edit_item' => __('Medienbericht bearbeiten'),
        'view_item' => __('Medienbericht ansehen'),
        'all_items' => __('Alle Medienberichte'),
        'search_items' => __('Medienberichte suchen'),
        'not_found' => __('keine Medienberichte gefunden'),
    );
    ...
    $args = array(
        ...
        'rewrite' => array('slug' => 'medienbericht'),
        // 'rewrite' => false,
        'hierarchical' => false,
    );

    register_post_type('medienbericht', $args);
}
add_action('init', 'create_post_type_medienbericht', 5);

// Add Custom Tag Taxonomy
function register_medienbericht_category() {
    ...
    register_taxonomy( 'medienbericht_category', array( 'medienbericht' ), $args );

}

add_action( 'init', 'register_medienbericht_category', 0 );
}